...
public class CameraZoom
{
    ...
    public void Init(CinemachineVirtualCamera _cam, CameraInputData _data)
    {
        m_camInputData = _data;

        m_cam = _cam;
        m_initFOV = m_cam.m_Lens.FieldOfView;
    }
    ...
    IEnumerator ChangeFOVRoutine()
    {
        ...
        float _currentFOV = m_cam.m_Lens.FieldOfView;
        ...
        while (_percent < 1f)
        {
            ...
            m_cam.m_Lens.FieldOfView = Mathf.Lerp(_currentFOV, _targetFOV, _smoothPercent);
            yield return null;
        }
    }
